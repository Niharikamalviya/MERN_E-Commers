        ...
        <div className="container mx-auto px-4 my-6 relative ">
            ...
            <div className="flex items-center gap-4 md:gap-6 overflow-scroll scrollbar-none">
                ...
                <div className="flex justify-between w-full text-3xl text-slate-200">
                    <button className="absolute left-0 bg-white shadow-md rounded-full p-1 hidden md:block"><IoIosArrowBack /></button>
                    <button className="absolute-rigth-0 bg-white shadow-md rounded-full p-1 hidden md:block"><IoIosArrowForward /></button>
                </div>
                    ...
                    data.map((product, index) => {
                        return (
                            <div className="w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] h-36 bg-white flex rounded-sm shadow-md">
                                ...
                                <div>
                                    <button className="text-sm bg-red-600 hover:bg-red-700 text-white px-2 py-1 rounded-full ">Add to cart</button>
                                </div>
